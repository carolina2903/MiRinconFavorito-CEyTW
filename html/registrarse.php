        ...
        <form>
            ...
            <div class="form-group">
                <input type="email" class="form-control" id="email" aria-describedby="emailHelp"
                    placeholder="Email" value="email12345@email.com">
            </div>
            <div class="form-group">
            ...
            <div class="form-check">
                <button class="btn btn-info" style="float: right">Registrarse</button>
            </div>
            <br><br><br>
        </form>
