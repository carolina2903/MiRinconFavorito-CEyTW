...
<div class="col-sm-8">
    <div class="mb-3">
    <h3 class="card-title">Cojines Profesión Dobles</h3>
    <h5>24,00€</h5>
...
if (isset($_POST['nombre_izquierda'])&&(isset($_POST['nombre_derecha']))&&(isset($_POST['profesionderecha']))&&(isset($_POST['profesionizquierda']))){
    ...
    */
    ...
    if (!isset($_SESSION["carrito"])) {
        $_SESSION["carrito"][0]=array('id_producto'=>$id_producto_creado, 'id_tipo_producto'=>8, 'precio_unidad'=>24, 'tamaño'=>"30x50", 'nombre'=>"Cojines Profesión Dobles", 'cantidad'=>1, 'profesionizquierda'=>$profesionizquierda, 'nombreizquierda'=>$nombreizqdo, 'profesionderecha'=>$profesionderecha, 'nombrederecha'=>$nombredrcho);
    }else 
        $_SESSION["carrito"][]=array('id_producto'=>$id_producto_creado, 'id_tipo_producto'=>8, 'precio_unidad'=>24, 'tamaño'=>"30x50", 'nombre'=>"Cojines Profesión Dobles", 'cantidad'=>1, 'profesionizquierda'=>$profesionizquierda, 'nombreizquierda'=>$nombreizqdo, 'profesionderecha'=>$profesionderecha, 'nombrederecha'=>$nombredrcho);
