...
if (isset($_POST['nombre_apellido'])&&isset($_POST['dibujo'])){
    ...
    */
    ...
    if (!isset($_SESSION["carrito"])) {
        $_SESSION["carrito"][0]=array('id_producto'=>$id_producto_creado, 'id_tipo_producto'=>4, 'nombre'=>$nombre_apellido, 'dibujo'=>$dibujo, 'fecha'=>$fecha, 'precio_unidad'=>13, 'tamaño'=>"30x50", 'nombre'=>"Cojín Dibujo Individual", 'cantidad'=>1);

    }else 
    $_SESSION["carrito"][]=array('id_producto'=>$id_producto_creado, 'id_tipo_producto'=>4, 'nombre'=>$nombre_apellido, 'dibujo'=>$dibujo, 'fecha'=>$fecha, 'precio_unidad'=>13, 'tamaño'=>"30x50", 'nombre'=>"Cojín Dibujo Individual", 'cantidad'=>1);
